...
INSERT INTO sprint (status_code, startpoint, endpoint, title, project_id) VALUES ('planning', '2023-04-09 23:05:05.000000', '2023-04-12 23:05:12.000000', 'Sprint-1', 2);

INSERT INTO task (title, description, type_code, status_code, priority_code, estimate, updated, project_id, sprint_id, parent_id, startpoint, endpoint) VALUES ('Task-1', 'short test task', 'task', 'in progress', 'high', null, null, 2, 2, null, null, null);
INSERT INTO task (title, description, type_code, status_code, priority_code, estimate, updated, project_id, sprint_id, parent_id, startpoint, endpoint) VALUES ('Task-2', 'test 2 task', 'bug', 'ready', 'normal', null, null, 2, 2, null, null, null);
INSERT INTO task (title, description, type_code, status_code, priority_code, estimate, updated, project_id, sprint_id, parent_id, startpoint, endpoint) VALUES ('Task-3', 'test 3 descr', 'task', 'done', 'low', null, null, 2, 2, null, null, null);
INSERT INTO task (title, description, type_code, status_code, priority_code, estimate, updated, project_id, sprint_id, parent_id, startpoint, endpoint) VALUES ('Task-4', 'test 4', 'bug', 'in progress', 'normal', null, null, 2, 2, null, null, null);
